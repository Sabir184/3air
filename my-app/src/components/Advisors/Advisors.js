      ...
      >
        <Row>
          <Col
            ...
            sm={12}
            xsm={12}
            className="advisors-members"
          >
            <Member
              ProfileImage={'./assets/babs.svg'}
              ProfileLink={
                'https://www.linkedin.com/in/emmexdee/?originalSubdomain=ng'
              }
          ...
          <Col xlg={3} lg={3} md={4} sm={12} xsm={12} className="team-members">
            <Member
              ...
              ProfileLink={
                'https://www.linkedin.com/in/denis-bolcina-232203b5/'
              }
          ...
          <Col xlg={3} lg={3} md={4} sm={12} xsm={12} className="team-members">
            <Member
              ...
              ProfileLink={
                'https://www.linkedin.com/in/oliver-von-wolff-63146639/'
              }
