                        ...
                        <Col xl={8} lg={8} md={6} sm={12} xsm={12} >
                            ...
                            <div>
                                <ButtonGroup className="hero-btns">
                                    <Button className='litepaper' href='https://forwardprotocol.io' target='_blank'>LITEPAPER
                                        <img src='assets/whitearrow.svg' alt='arrow' />
                                    </Button>
                                    <Button className='asal-join' href='https://forwardprotocol.io' target='_blank'>
